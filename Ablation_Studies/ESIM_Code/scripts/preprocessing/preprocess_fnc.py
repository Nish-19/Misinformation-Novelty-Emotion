...
from data_fnc import Preprocessor
...
if __name__ == "__main__":
    default_config = "../../config/preprocessing/fnc_preprocessing.json"

    parser = argparse.ArgumentParser(description="Preprocess the FNC dataset")
    parser.add_argument(
        "--config",
        default=default_config,
        help="Path to a configuration file for preprocessing FNC"
    )
