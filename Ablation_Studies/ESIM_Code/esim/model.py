...
class ESIM(nn.Module):
    ...
    def __init__(self,
        ...
        # self._classification_1 = nn.Sequential(nn.Dropout(p=self.dropout),
        #                                      nn.Linear(2*4*self.hidden_size,
        #                                                self.hidden_size),
        #                                      nn.Tanh())

        # self._classification_2 = nn.Sequential(nn.Dropout(p=self.dropout),
        #                                      nn.Linear(self.hidden_size,
        #                                                self.num_classes))
    ...
    def forward(self,
        ...
        for i, l in enumerate(self._classification):
            #print(l)
            if i==0:
                x = l(v)
            else:
        ...
        # # Pre_logits is the tanh output of the previous layer
        # pre_logits = x
        ...
        return pre_logits, logits, probabilities
